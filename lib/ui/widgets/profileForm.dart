...
import 'package:tinder_clone/bloc/authentication/authentication_event.dart';
...
class _ProfileFormState extends State<ProfileForm> {
  ...
  bool isButtonEnabled(ProfileState state) {
    ...
    print('ye wala -> '+ isFilled.toString());
  ...
  _getLocation() async {
    ...
    print('in location -> '+location.toString());
  }

  _onSubmitted() async {
    await _getLocation();
    print('hey!!'+age.toString());
    _profileBloc.add(
      Submitted(
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        print(age);
                        print('yaha to dekho '+isButtonEnabled(state).toString());
